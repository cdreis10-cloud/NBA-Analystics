            ...
            <table className="data-table">
              <thead>
                <tr>
                  ...
                  <th>Salary</th>
                  <th 
                    className="w-36 cursor-pointer hover:text-white select-none"
                    onClick={() => handleSort('talent')}
                  >
                    <div className="flex items-center gap-1">
                      Talent
                      {sortField === 'talent' && (sortDir === 'desc' ? <ChevronDown size={12} /> : <ChevronUp size={12} />)}
                    </div>
                  </th>
                  <th 
                    className="w-36 cursor-pointer hover:text-white select-none"
                  ...
                  >
                    <div className="flex items-center gap-1">
                      Opportunity
                      {sortField === 'opportunity' && (sortDir === 'desc' ? <ChevronDown size={12} /> : <ChevronUp size={12} />)}
                    </div>
                  </th>
                  <th 
                    className="cursor-pointer hover:text-white select-none"
                    onClick={() => handleSort('breakout')}
                  >
                    <div className="flex items-center gap-1">
                      Score
                      {sortField === 'breakout' && (sortDir === 'desc' ? <ChevronDown size={12} /> : <ChevronUp size={12} />)}
                    </div>
                  </th>
                  <th>Tier</th>
                  <th>Ceiling</th>
                    ...
                    <tr key={player.id}>
                      ...
                      <td>
                        <div className="flex items-center gap-2">
                          <span className="font-mono text-[13px] text-white w-10 text-right">{Math.round(talent)}</span>
                      ...
                      <td>
                        <div className="flex items-center gap-2">
                          <span className="font-mono text-[13px] text-white w-10 text-right">{Math.round(opportunity)}</span>
                          <div className="flex-1 min-w-[60px]">
